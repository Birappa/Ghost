...
public class GhostActivity extends AppCompatActivity {
    ...
    private void computerTurn() {
       /* TextView label = (TextView) findViewById(R.id.gameStatus);
        ...
        if (dictionary.isWord(word) && word.length() >= 4) {
            ...
            if (!longerWord.equals("noWord")&&!longerWord.equals("sameAsPrefix")) {
    ...
    public void challenge(View view) {
        ...
        if (currentWord.length() > 3 && dictionary.isWord(currentWord)) {
            ...
            String anotherWord = dictionary.getGoodWordStartingWith(currentWord);
            if (!anotherWord.equals("noWord")&&!anotherWord.equals("sameAsPrefix")) {
                gameStatus.setText("computer won");
